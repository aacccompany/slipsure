...
const features = [
  ...
  {
    icon: <Fingerprint className="w-6 h-6 text-blue-800" />,
    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <h2 className="text-xs font-bold text-blue-800 uppercase tracking-[0.2em] mb-4">จุดเด่นของระบบ</h2>
          <h3 className="text-4xl font-black text-zinc-900 tracking-tight">ทำไมต้องเลือก FlowSlip.ai?</h3>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div key={i} className="group p-8 bg-[#fafafa] border border-zinc-100 rounded-[2.5rem] hover:bg-white hover:border-blue-50 hover:shadow-2xl hover:shadow-blue-500/5 transition-all duration-500">

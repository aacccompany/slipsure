...
const sections = [
  ...
  {
    title: "Endpoints",
    icon: <Terminal className="w-5 h-5 text-blue-800" />,
    items: [
  ...
  },
  {
    ...
    icon: <Code className="w-5 h-5 text-blue-800" />,
    items: [
              ...
              <div key={i} className="space-y-4">
                ...
                <div className="flex flex-col gap-2 pl-7">
                  {section.items.map((item, j) => (
                    <a key={j} href={item.href} className="text-sm font-medium text-zinc-500 hover:text-blue-800 transition-colors">
                      {item.name}
                    </a>
                  ))}
                </div>
          ...
          <div className="lg:col-span-9 space-y-12">
            <div className="bg-white border border-zinc-100 rounded-[3rem] p-10 md:p-16 shadow-sm">
                ...
                <div className="p-8 bg-zinc-900 rounded-[2rem] text-white space-y-6">
                    ...
                    <pre className="font-mono text-sm text-blue-500 overflow-x-auto">
{`curl -X POST https://api.flowslip.ai/v1/verify \\
  ...
  -F "file=@slip.jpg"`}
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white border border-zinc-100 rounded-[2.5rem] p-10 hover:border-blue-50 transition-all shadow-sm group">
                    ...
                    <Link href="#" className="inline-flex items-center gap-2 text-blue-800 font-bold text-sm hover:gap-3 transition-all">

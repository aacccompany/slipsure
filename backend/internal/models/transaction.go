...
// RetryRequest represents request to retry verification
type RetryRequest struct{}

// RetryResponse represents response for retry request
type RetryResponse struct {
	TransactionID uuid.UUID         `json:"transaction_id"`
	Status        TransactionStatus `json:"status"`
}

// ConfirmRequest represents admin confirmation request
...
// ManualRecheckRequest represents admin manual recheck request
type ManualRecheckRequest struct {
